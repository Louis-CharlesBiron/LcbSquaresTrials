class GameText {
    static DEFAULT_FADING_DISTANCE = 100
    static DEFAULT_TEXT_LOOP_EFFECT = (obj)=>{
        obj.a = CDEUtils.mod(1, CDEUtils.getRatio(GameManager.instance.player.obj, obj, GameText.DEFAULT_FADING_DISTANCE), 0.95)
    }
